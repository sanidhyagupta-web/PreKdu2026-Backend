...
public class Employee {
    ...
    public static List<Employee> getHighEarningEmployee(List<Employee> emp){
        return emp.stream().
    ...
    public static List<String> getStandardizedEmployee(List<Employee> emp){
        return emp.stream().
                map(x->x.name == null ? null : x.name.toUpperCase()).
                toList();
    }

    public static Double getTotalAnnualBudget(List<Employee> emp){
        return emp.stream().
    ...
    public static void main(String[] args) {
        List<Employee> list = Employee.getSampleData();

        List<Employee> HighEarningEmployee = Employee.getHighEarningEmployee(list);
        System.out.println(HighEarningEmployee);

        System.out.println(Employee.getStandardizedEmployee(list));

        System.out.println(Employee.getTotalAnnualBudget(list));
    }
}
